...
// Get recent files
$files = $fileManager->getRecentFiles($user['id']);
        ...
        <div class="main-panel p-4 dashboard-main">
            ...
            <div class="row align-items-center justify-content-between dashboard-head-row g-3 mb-4">
                <div class="col-lg-8">
                    <div class="dashboard-access-row d-flex flex-column flex-md-row align-items-center justify-content-between gap-3 mb-4">
                        <div>
                            <h4 class="mb-1"><i class='bx bx-time me-2'></i>Recently Accessed Files</h4>
                            <p class="text-muted mb-0">Files you've recently opened or modified.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <?php if (empty($files)): ?>
                <div class="empty-state-card card border-0 shadow-sm text-center py-5 px-4 mb-4">
                    <div class="card-body">
                        <i class='bx bx-time bx-lg mb-3' style="color: #ccc;"></i>
                        <h4 class="mb-2">No recent files</h4>
                        <p class="text-muted mb-4">Files you access will appear here.</p>
                                                        ...
                                                        <li>
                                                            <form method="POST" class="d-inline">
                                                                ...
                                                                <button type="submit" name="toggle_star" class="dropdown-item">
                                                                    <i class='bx bx-star me-2'></i><?= $file['is_starred'] ? 'Unstar' : 'Star' ?>
                                                                </button>
                                                            </form>
                                                        </li>
                                                        <li>
